...
export class FileService {
  ensureKayaDirectories() {
    ...
    if (!kayaDirFile.query_exists(null)) {
      try {
        ...
        console.error("Failed to create ~/.kaya directory:", [e]);
      }
    }
    ...
    if (!angaDirFile.query_exists(null)) {
      try {
        ...
        console.error("Failed to create ~/.kaya/anga directory:", [e]);
      }
    }
    ...
    if (!metaDirFile.query_exists(null)) {
      try {
        ...
        console.error("Failed to create ~/.kaya/meta directory:", [e]);
      }
    }
  }
  ...
  save(angaFile: AngaFile) {
    ...
    console.log(`Saved bookmark to ${filePath}`);
  }
