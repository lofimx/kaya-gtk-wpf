...
LLM agents must create a Markdown plan document **in this directory** (`gtk/doc/plan/`) before porting any feature/bugfix from GTK, or performing a Windows-specific bugfix, named with this pattern:

* `2025-12-25-add-plaintext-indexing.md`
